...
function PricingPage() {
  ...
  const plans = [
    ...
    { name: "Builder", price: { m: "$12", a: "$99" }, period: { m: "per month", a: "per year · save $45" }, link: { m: "https://checkout.dodopayments.com/buy/pdt_0NaxpxHWNyAX0fOVNqvVd?quantity=1", a: "https://checkout.dodopayments.com/buy/pdt_0NaxpbrnHJRgzNOXhY7IQ?quantity=1" }, popular: true, cta: "Start Building", cls: "main", features: [{ ok: true, t: "Unlimited blueprints" }, { ok: true, t: "All 3 phases" }, { ok: true, t: "Tool recommendations" }, { ok: true, t: "PDF + Markdown + JSON" }, { ok: true, t: "Blueprint history" }, { ok: false, t: "API access", dim: true }] },
    { name: "Pro", price: { m: "$29", a: "$249" }, period: { m: "per month", a: "per year · save $99" }, link: { m: "https://checkout.dodopayments.com/buy/pdt_0NaxpwrTxvvYk81pF4vop?quantity=1", a: "https://checkout.dodopayments.com/buy/pdt_0Naxpb1BvZdzYA01ssY9B?quantity=1" }, popular: false, cta: "Go Pro", cls: "outline", features: [{ ok: true, t: "Everything in Builder" }, { ok: true, t: "API access" }, { ok: true, t: "Custom PDF branding" }, { ok: true, t: "Notion & Linear export" }, { ok: true, t: "Priority support" }, { ok: true, t: "Early feature access" }] }
  ];
  return (
